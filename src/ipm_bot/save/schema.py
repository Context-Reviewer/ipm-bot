...
FIELD_INVENTORY: tuple[SchemaField, ...] = (
    ...
    SchemaField(
        "freeRewardsClaimedCount",
        "free_rewards_claimed_count",
        "event",
        "Int32",
        "Derived count of claimed free-event rewards from List<bool> freeRewardsClaimed.",
    ),
    SchemaField(
        "freeRewardsTotalCount",
        "free_rewards_total_count",
        "event",
        "Int32",
        "Derived length of List<bool> freeRewardsClaimed.",
    ),
    SchemaField(
        "minerPassRewardsClaimedCount",
        "miner_pass_rewards_claimed_count",
        "event",
        "Int32",
        "Derived count of claimed miner-pass rewards from List<bool> minerPassRewardsClaimed.",
    ),
    SchemaField(
        "minerPassRewardsTotalCount",
        "miner_pass_rewards_total_count",
        "event",
        "Int32",
        "Derived length of List<bool> minerPassRewardsClaimed.",
    ),
    SchemaField(
        "freeRewardsClaimed",
